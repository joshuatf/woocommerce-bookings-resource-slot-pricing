...
/**
 * WC_Bookings_Resource_Slot_Pricing_Meta_Box.
 */
class WC_Bookings_Resource_Slot_Pricing_Meta_Box {
	...
	public function __construct() {
		$this->id         = 'woocommerce-bookable-resource-data-custom';
						...
						<table class="widefat">
							<thead>
								<tr>
									...
									<th><?php esc_html_e( 'Price Change', 'woocommerce-bookings' ); ?></th>
							...
							<tfoot>
								<tr>
									<th colspan="6">
										...
										ob_start();
										include( 'partials/html-booking-availability-fields.php' );
										$html = ob_get_clean();
										echo esc_attr( $html );
	...
	private function get_posted_availability() {
		...
		for ( $i = 0; $i < $row_size; $i ++ ) {
            ...
            $availability[ $i ]['price_change'] = intval( $_POST['wc_booking_availability_price_change'][ $i ] );
...
return new WC_Bookings_Resource_Slot_Pricing_Meta_Box();
